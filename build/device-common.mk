...
EXTERNAL_DIR = $(GCC4MBED_DIR)/compiler/external

# Include path which points to subdirectories of this project, MRI, and user specified directory.
INCLUDE_DIRS := $(patsubst %,-I%,$(INCDIRS) $(SRC) $(call recurse_dir,$(SRC)) $(GCC4MBED_DIR)/compiler/mri)
...
LIBS      += $(GCC4MBED_DIR)/compiler/mri/mri.ar
endif
LIBS      += $(MBED_LIBRARIES)
LIBS      += $(LIBS_SUFFIX)
...
$(OUTDIR)/gcc4mbed.o : $(GCC4MBED_DIR)/compiler/src/gcc4mbed.c makefile
	@echo Compiling $<
